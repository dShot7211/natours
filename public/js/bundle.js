...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, session, checkoutPageUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NZWFNSC3K7F0fmdbVKvQsUQ91XLIe0a1BntWwWKYuBqMR3Rjjf83h7yo0WsaoGy3SMsIAHJli5bOotu0pDUI0QR00ptIZ6QJv'); // we get Stripe from the script that we included in tour.pug

          console.log('stripe', stripe); // 1) Get checkout session from API
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // upload image with form data
